...
class CollaborationHubContentTest extends MediaWikiTestCase {
	...
	public function testGetParsedAnnouncements( CollaborationHubContent $content, $id ) {
		...
		$block = "<h3>" . wfMessage( 'collaborationkit-hub-pagetitle-announcements' ) . "<span aria-disabled='false' class='mw-ck-hub-section-button mw-editsection-like oo-ui-widget oo-ui-widget-enabled oo-ui-buttonElement oo-ui-buttonElement-frameless oo-ui-iconElement oo-ui-labelElement oo-ui-flaggedElement-progressive oo-ui-buttonWidget'><a role='button' tabindex='0' aria-disabled='false' href='/wiki/index.php?title=Main_Page/Announcements&amp;action=edit' rel='nofollow' class='oo-ui-buttonElement-button'><span class='oo-ui-iconElement-icon oo-ui-icon-edit oo-ui-image-progressive'></span><span class='oo-ui-labelElement-label'>" . wfMessage( 'Edit' ) . "</span><span class='oo-ui-indicatorElement-indicator oo-ui-indicatorElement-noIndicator oo-ui-image-progressive'></span></a></span></h3>* The cafeteria is out of empanadas. We apologize for the inconvenience.";
		$expected = [ $block, $block, $block ];
		$wc = TestingAccessWrapper::newFromObject( $content );
	...
	public function testGetSecondFooter( CollaborationHubContent $content, $id ) {
		global $wgServer;
		$block = "<span aria-disabled='false' class='oo-ui-widget oo-ui-widget-enabled oo-ui-buttonElement oo-ui-buttonElement-framed oo-ui-iconElement oo-ui-labelElement oo-ui-flaggedElement-progressive oo-ui-buttonWidget'><a role='button' tabindex='0' aria-disabled='false' href='/wiki/index.php?title=Main_Page&amp;action=edit' rel='nofollow' class='oo-ui-buttonElement-button'><span class='oo-ui-iconElement-icon oo-ui-icon-edit oo-ui-image-progressive'></span><span class='oo-ui-labelElement-label'>" . wfMessage( 'collaborationkit-hub-manage' ) . "</span><span class='oo-ui-indicatorElement-indicator oo-ui-indicatorElement-noIndicator oo-ui-image-progressive'></span></a></span><span aria-disabled='false' class='oo-ui-widget oo-ui-widget-enabled oo-ui-buttonElement oo-ui-buttonElement-framed oo-ui-iconElement oo-ui-labelElement oo-ui-flaggedElement-progressive oo-ui-buttonWidget'><a role='button' tabindex='0' aria-disabled='false' href='" . $wgServer . "/wiki/index.php?title=Special:CreateHubFeature&amp;collaborationhub=Main+Page' rel='nofollow' class='oo-ui-buttonElement-button'><span class='oo-ui-iconElement-icon oo-ui-icon-add oo-ui-image-progressive'></span><span class='oo-ui-labelElement-label'>" . wfMessage( 'collaborationkit-hub-addpage' ) . "</span><span class='oo-ui-indicatorElement-indicator oo-ui-indicatorElement-noIndicator oo-ui-image-progressive'></span></a></span>";
		$expected = [ $block, $block, $block ];
		$wc = TestingAccessWrapper::newFromObject( $content );
